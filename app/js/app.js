const data = {
  ...
  time: 1577811600000 // Epoch timestamp, since 01/01/2020
};
...
function update() {
  ...
  data.koma = (data.savings - Math.floor(data.savings))
    ...
    .split(".")[1];
  updatePies();
  document.getElementById("rupiah").innerText = data.rupiah;
  document.getElementById("koma").innerText = data.koma;
